...
/**
 * TODO: document ContentAttrElementEventWorker
 * 
 * @author Gabriel Roldan (OpenGeo)
 * @version $Id$
 */
final class ContentAttrElementEventWorker extends AbstractAttrElementEventWorker {

    /**
     * Explicitly delegates to super.nextImpl() since this class controls the
     * {@link TokenType#ContentAttrElement ContentAttrElement} token, meaning its followed by at
     * least one attribute token, one content token and a {@link TokenType#ElementEnd ElementEnd}
     * token, and thus we don't need to mimic the END_ELEMENT event.
     * 
