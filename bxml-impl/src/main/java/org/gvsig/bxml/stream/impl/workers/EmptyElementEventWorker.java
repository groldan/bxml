...
/**
 * TODO: document EmptyElementEventWorker
 * 
 * @author Gabriel Roldan (OpenGeo)
 * @version $Id$
 */
final class EmptyElementEventWorker extends StartElementTypeWorker {

    /**
     * Overrides to explicitly return an {@link EndElementEventWorker} in order to force an
     * END_ELEMENT event, since this class controls the {@link TokenType#EmptyElement EmptyElement}
     * token, meaning its not followed by any attribute nor content token, and also is not followed
     * by a {@link TokenType#ElementEnd ElementEnd} token.
     * 
