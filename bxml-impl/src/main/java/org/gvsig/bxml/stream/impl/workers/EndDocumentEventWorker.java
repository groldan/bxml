...
/**
 * TODO: implement EndDocumentEventWorker
 * 
 * @author Gabriel Roldan (OpenGeo)
 * @version $Id$
 */
final class EndDocumentEventWorker extends EventTypeWorker {

    @Override
    public EventTypeWorker nextImpl(final BxmlInputStream stream, final ParseState state)
            throws IOException {
        throw new IllegalStateException("End of document already reached");
    }
