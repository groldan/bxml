...
/**
 * TODO: document AttributesEndEventWorker
 * 
 * @author Gabriel Roldan (OpenGeo)
 * @version $Id$
 */
final class AttributesEndEventWorker extends EventTypeWorker {

    /**
     * @return {@link EventType#ATTRIBUTES_END}
    ...
    public EventType getEventType(final ParseState state) {
        return EventType.ATTRIBUTES_END;
    }
